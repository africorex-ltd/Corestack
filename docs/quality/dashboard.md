...
| Metric               | Value                                                                                                                                                          |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test files / tests   | 55 files / **431 tests** (kernel 101 · lint fixtures 15 · architecture fitness 26 · platform 191 unit + 91 integration · example module 3 unit + 4 integration) |
