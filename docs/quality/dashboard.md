...
| Metric               | Value                                                                                                                                                          |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test files / tests   | 55 files / **444 tests** (kernel 110 · lint fixtures 15 · architecture fitness 26 · platform 191 unit + 95 integration · example module 3 unit + 4 integration) |
