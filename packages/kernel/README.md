...
| Idempotency   | `ProcessedEventStore`, `idempotentHandler`, in-memory store                                                                      | At-least-once consumers dedupe by event id; real adapters mark atomically with effects  |
