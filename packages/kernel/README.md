...
| Logging              | `Logger` port, `NoopLogger`, `CaptureLogger`, `SENSITIVE_LOG_KEYS`, `redactSensitiveFields`, `serializeErrorForLog`              | Structured, child-context logging; runtime redaction (ADR-0022) behind the lint deny-list |
